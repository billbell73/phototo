...
describe TagsController do
  ...
  #       post :create, {:tag => { "content" => "invalid value" }}, valid_session
  #       assigns(:tag).should be_a_new(Tag)
  #     end
  ...
  #       Tag.any_instance.should_receive(:update).with({ "content" => "MyString" })
  #       put :update, {:id => tag.to_param, :tag => { "content" => "MyString" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Tag.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => tag.to_param, :tag => { "content" => "invalid value" }}, valid_session
  #       assigns(:tag).should eq(tag)
  #     end
